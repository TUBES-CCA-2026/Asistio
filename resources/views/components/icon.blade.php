...
@endphp
<svg xmlns="http://www.w3.org/2000/svg" width="{{ $size ?? 18 }}" height="{{ $size ?? 18 }}" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="{{ $style ?? '' }}" class="{{ $class ?? '' }}" aria-hidden="true">
    {!! $icons[$name] ?? '' !!}
</svg>
