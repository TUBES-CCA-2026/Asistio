...
<div class="card"><div class="table-wrapper"><table class="table">
    ...
    <tr>
        ...
        <td class="fs-12"><?php echo e($k->asisten2?->nama_asisten ?? '—'); ?></td>
        <td>
            <div style="display:flex;gap:6px;">
            <a href="<?php echo e(route('laboran.kelas.show',$k)); ?>" class="btn btn-sm btn-outline">Edit</a>
            <form method="POST" action="<?php echo e(route('laboran.kelas.destroy',$k)); ?>"><?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?>
            <button class="btn btn-sm btn-danger" onclick="return confirm('Hapus kelas ini?')">Hapus</button></form>
            </div>
        </td>
    </tr>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><tr><td colspan="8"><div class="empty-state"><p>Belum ada kelas praktikum.</p></div></td></tr>
    <?php endif; ?>
    </tbody>
</table></div></div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\tes1\resources\views/laboran/kelas/index.blade.php ENDPATH**/ ?>