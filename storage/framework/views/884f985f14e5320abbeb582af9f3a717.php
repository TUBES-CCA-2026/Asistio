...
<div class="card"><div class="table-wrapper"><table class="table">
    ...
    <?php $alpaTinggi = $m->melebihiBatasAlpa(); ?>
    <tr class="<?php echo e($alpaTinggi ? 'row-alpa-alert' : ''); ?>">
        <td style="font-family:monospace;font-size:13px;"><?php echo e($m->nim_mahasiswa); ?></td>
        <td><div style="display:flex;align-items:center;gap:8px;"><div class="avatar avatar-sm"><?php echo e($m->initials); ?></div><span class="fw-600"><?php echo e($m->nama_mahasiswa); ?></span>
            <?php if($alpaTinggi): ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\asistio\resources\views/laboran/mahasiswa/index.blade.php ENDPATH**/ ?>