...
<div class="card"><div class="table-wrapper"><table class="table">
    ...
    <tr>
        ...
        <td class="fs-12">
            <?php $__empty_2 = true; $__currentLoopData = $d->praktikum; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                <span style="display:block;"><?php echo e($p->mataKuliah?->kode_mk); ?> — <?php echo e($p->nama_kelas); ?></span>
