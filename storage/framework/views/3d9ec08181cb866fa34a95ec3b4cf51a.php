...
<?php echo e($praktikum->mataKuliah?->nama_mk); ?> — <?php echo e($praktikum->nama_kelas); ?>

<?php if($praktikum->dosen): ?>
<span style="font-weight:400;opacity:.75;font-size:.9em;">· Dosen: <?php echo e($praktikum->dosen->nama_dosen); ?></span>
<?php endif; ?>
