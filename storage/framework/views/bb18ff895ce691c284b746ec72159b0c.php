...
<div class="card"><div class="table-wrapper" style="overflow-x:auto;">
    <table class="table" style="min-width:1900px;">
        <thead><tr>
            <th>Mahasiswa</th>
            <?php for($i = 1; $i <= 14; $i++): ?>
            <th style="text-align:center;">P<?php echo e($i); ?></th>
            <?php endfor; ?>
        ...
        <tr>
            ...
            <?php for($i = 1; $i <= 14; $i++): ?>
            <td><input type="number" name="p<?php echo e($i); ?>" class="form-control form-control-xs" min="0" max="100" value="<?php echo e($n['evaluasi']->{'p'.$i} ?? ''); ?>" placeholder="—"></td>
            <?php endfor; ?>
        ...
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><tr><td colspan="22"><div class="empty-state"><p>Belum ada mahasiswa.</p></div></td></tr>
        <?php endif; ?>
        </tbody>
    </table></div>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\asistio\resources\views/asisten/nilai.blade.php ENDPATH**/ ?>