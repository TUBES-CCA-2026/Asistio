...
<div class="card" style="max-width:480px;">
    <div class="card-body" style="padding:24px;">
        <form method="POST" action="<?php echo e(route('dosen.ganti-password.update')); ?>">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\tes1\resources\views/dosen/ganti-password.blade.php ENDPATH**/ ?>